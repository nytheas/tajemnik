...
def odeslat_mail():
    ...
    sender_email = "fake.tajemnik@seznam.cz"
    receiver_email = 'fake.tajemnik@seznam.cz'
    ...
    filename = 'uvazekPavelVaracha.xlsx'
    # filename = 'test.xlsx'
    ...
    with smtplib.SMTP_SSL("smtp.seznam.cz", 465) as server:
        server.ehlo()
        server.login('fake.tajemnik@seznam.cz', 'heslo1234')
